...
<?php  include('config/connection.php'); 
        ...
        $data_queary = "SELECT SUM(invoice_total_price) AS payable,SUM(invoice_paid) AS paid,SUM(invoice_transpot_price) AS transport,SUM(invoice_tax_ammount) AS tax, COUNT(invoice_tax_ammount) AS counts, SUM(invoice_discount_ammount) AS discount, SUM(invoice_products_price) AS product FROM `tbl_invoice` WHERE  invoice_activity='A'";
        ...
        <div class="card margin-20">
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40">
                    ...
                    $queary = "SELECT invoice_id,`clint_id`,`invoice_tax_parcent`,`invoice_tax_ammount`,`invoice_discount_parcent`,`invoice_discount_ammount`,`invoice_products_price`,`invoice_paid`,`invoice_total_price`,`invoice_transpot_price`,`invoice_date` FROM `tbl_invoice` WHERE invoice_activity='A' ORDER BY `invoice_date` DESC";
