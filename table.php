...
<div class="row page-titles margin-0">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Manage Client</h4>
    </div>
        ...
        <div class="card margin-20">
            <div class="card-body">
                ...
                <div class="table-responsive m-t-40">
                    <table id="clientTABLE" class="table product-overview">
                        <thead>
                            <tr>
                                <th>Sr.No.</th>
                                <th>Name</th>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="driver_update_modal(<?php echo $db_id; ?>)" class="text-inverse p-r-10" data-bs-toggle="tooltip" title="" data-original-title="Edit"><i class="ti-marker-alt"></i></a>
                                    ...
                                    <a onclick="driver_delete_modal(<?php echo $db_id; ?>)" class="text-inverse p-r-10" title="" data-bs-toggle="tooltip" data-original-title="Delete"><i class="icon-cloud-download"></i></a>
                                </td>
                            </tr>
                        <?php
                         }
    ...
    <div class="modal-dialog width-900" role="document">
        <div class="modal-content top-margin-20">
            <div class="modal-header">
                ...
                <button type="button" onclick="client_delete_modal_close()" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" onclick="client_delete_modal_close()" class="btn btn-secondary" data-dismiss="modal">Close</button>
